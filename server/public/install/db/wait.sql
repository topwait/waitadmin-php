...
CREATE TABLE `wait_sys_log`  (
  ...
  `ua` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '请求UA',
...
INSERT INTO `wait_sys_config` VALUES (43, 'pc', 'logo', 'static/common/init/logo_pc.png', 'PC图标', 1665319505, 1679125300);
INSERT INTO `wait_sys_config` VALUES (50, 'h5', 'title', 'WaitAdmin开源系统', 'H5标题', 1665319505, 1679125300);
INSERT INTO `wait_sys_config` VALUES (51, 'h5', 'logo', 'static/common/init/logo_h5.png', 'H5图标', 1665319505, 1679125300);
...
INSERT INTO `wait_sys_config` VALUES (202, 'watermark', 'icon', 'static/common/watermark.png', '水印图片文件', 1665319505, 1665319505);
...
INSERT INTO `wait_sys_config` VALUES (800, 'diy', 'tabbar', '{\"style\":{\"selectedColor\":\"#2979ff\",\"unselectedColor\":\"#333333\"},\"list\":[{\"text\":\"\\u9996\\u9875\",\"iconPath\":\"/static/common/init/tab_home.png\",\"selectedIconPath\":\"/static/common/init/tab_home_no.png\"},{\"text\":\"\\u8d44\\u8baf\",\"iconPath\":\"/static/common/init/tab_archive.png\",\"selectedIconPath\":\"/static/common/init/tab_archive_no.png\"},{\"text\":\"\\u6211\\u7684\",\"iconPath\":\"/static/common/init/tab_user.png\",\"selectedIconPath\":\"/static/common/init/tab_user_no.png\"}]}', 'tabBar导航', 1665319505, 1665319505);
INSERT INTO `wait_sys_config` VALUES (801, 'diy', 'person', '{\"service\":{\"base\":{\"layout\":\"col\",\"number\":\"5\",\"title\":\"\\u6211\\u7684\\u670d\\u52a1\"},\"list\":[{\"image\":\"/static/common/init/me_user.png\",\"name\":\"\\u4e2a\\u4eba\\u8bbe\\u7f6e\",\"link\":\"\\/pages\\/user\\/intro\"},{\"image\":\"/static/common/init/me_customer.png\",\"name\":\"\\u8054\\u7cfb\\u5ba2\\u670d\",\"link\":\"\\/pages\\/other\\/customer\"},{\"image\":\"/static/common/init/me_about.png\",\"name\":\"\\u5173\\u4e8e\\u6211\\u4eec\",\"link\":\"\\/pages\\/other\\/about\"}]},\"adv\":{\"base\":{\"open\":1},\"list\":[{\"image\":\"/static/common/init/adv01.jpg\",\"name\":\"\\u5c31\\u5c06\\u8ba1\\u5c31\\u8ba1\",\"link\":\"\\/pages\\/article\\/detail?id=1\"},{\"image\":\"/static/common/init/adv02.jpg\",\"name\":\"\\u5c31\\u5c06\\u8ba1\\u5c31\\u8ba1\",\"link\":\"\\/pages\\/article\\/detail?id=1\"}]}}', '个人中心装修', 1665319505, 1665319505);
INSERT INTO `wait_sys_config` VALUES (802, 'diy', 'contact', '{\"title\":\"\\u6dfb\\u52a0\\u5ba2\\u670d\\u4e8c\\u7ef4\\u7801\",\"datetime\":\"\\u65e9\\u4e0a 9:00 - \\u665a\\u4e0a17:00\",\"mobile\":\"13800138000\",\"qq\":\"2474369941\",\"image\":\"static\\/common\\/init\\/contact_qr.png\"}', '联系客服装修', 1665319505, 1665319505);
...
INSERT INTO `wait_auth_menu` VALUES (5721, 5720, 'app', '装修页面', '', 'diy.tabbar/index', 0, 0, 0, 0, 1648696695, 1648696695, 0);
INSERT INTO `wait_auth_menu` VALUES (5722, 5720, 'app', '装修保存', '', 'diy.tabbar/save', 0, 0, 0, 0, 1648696695, 1648696695, 0);
INSERT INTO `wait_auth_menu` VALUES (5730, 5700, 'app', '个人中心', '', 'diy.person/index', 0, 1, 0, 0, 1648696695, 1648696695, 0);
INSERT INTO `wait_auth_menu` VALUES (5731, 5730, 'app', '装修页面', '', 'diy.person/index', 0, 0, 0, 0, 1648696695, 1648696695, 0);
INSERT INTO `wait_auth_menu` VALUES (5732, 5730, 'app', '装修保存', '', 'diy.person/save', 0, 0, 0, 0, 1648696695, 1648696695, 0);
INSERT INTO `wait_auth_menu` VALUES (5740, 5700, 'app', '客服设置', '', 'diy.contact/index', 0, 1, 0, 0, 1648696695, 1648696695, 0);
INSERT INTO `wait_auth_menu` VALUES (5741, 5740, 'app', '装修页面', '', 'diy.contact/index', 0, 0, 0, 0, 1648696695, 1648696695, 0);
INSERT INTO `wait_auth_menu` VALUES (5742, 5740, 'app', '装修保存', '', 'diy.contact/save', 0, 0, 0, 0, 1648696695, 1648696695, 0);
