...
-- ----------------------------
DROPTABLE IF EXISTS `__PREFIX__curd_table`;
CREATE TABLE `__PREFIX__curd_table`  (
...
-- ----------------------------
DROP TABLE IF EXISTS `__PREFIX__curd_table_column`;
CREATE TABLE `__PREFIX__curd_table_column`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
