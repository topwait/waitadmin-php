...
use app\backend\service\user\VisitorService;
 ...
 * 用户访问日志管理
 */
class VisitorController extends Backend
{
    /**
     * 用户日志列表
     *
    ...
    public function index(): View|Json
    {
        if ($this->isAjaxGet()) {
            ...
            $list = VisitorService::lists($this->request->get());
    ...
    public function detail(): View
    {
        ...
        return view('', [
            'detail' => VisitorService::detail($id)
        ]);
    }
}